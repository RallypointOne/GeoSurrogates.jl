...
arrows!(ax3, [x for x in arrow_xs for _ in arrow_ys], [y for _ in arrow_xs for y in arrow_ys],
...
fit!(terrain_model, elev_norm; steps=20)
...
arrows!(ax1, [x for x in arrow_xs for _ in arrow_ys], [y for _ in arrow_xs for y in arrow_ys],
        vec(u_sub), vec(v_sub), lengthscale=0.15, color=:black)
...
arrows!(ax2, [x for x in arrow_xs for _ in arrow_ys], [y for _ in arrow_xs for y in arrow_ys],
